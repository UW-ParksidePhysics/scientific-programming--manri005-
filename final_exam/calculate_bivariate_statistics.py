...
if __name__ == "__main__":
    ...
    for name, expected, value in zip(stat_names, expected_values, calculate_bivariate_statistics([sample_x, sample_y])):
        print(f'{name}: {expected}, {value.mean}, {value.variance}, {value.minmax[0]}, {value.minmax[1]}')
